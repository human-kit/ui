<script lang="ts">
	...
	// Only `'grid'` navigation makes a body cell a focus target. In the other
	// modes it skips the focus registry and the focus-derived state below, which
	// a virtualizer would otherwise pay per cell on every scroll block.
