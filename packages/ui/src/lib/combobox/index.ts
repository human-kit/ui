...
import type ComboBoxStatusComponent from './status/combobox-status.svelte';
...
export { default as ComboBoxStatus } from './status/combobox-status.svelte';
...
export type ComboBoxStatusProps = ComponentProps<typeof ComboBoxStatusComponent>;
