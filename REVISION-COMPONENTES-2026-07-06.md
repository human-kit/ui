...
**Seguimiento menor restante (no bloqueante):** decisión de diseño sobre semántica radiogroup para toggle-group `single` (documentar o implementar); revisar la cola residual de bajos puramente cosméticos en las secciones por componente que no cambian comportamiento.
