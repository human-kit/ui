			...
			<Calendar.Grid class="flex gap-4 text-gray-900 dark:text-gray-100">
				...
				<Calendar.GridBody>
					{#snippet children(date)}
						<Calendar.BodyCell
							{date}
							class="p-1 text-center text-gray-900 data-disabled:text-red-600 data-outside-month:opacity-45 data-selected:rounded data-selected:bg-blue-600 data-selected:text-white dark:text-gray-100 dark:data-disabled:text-red-400"
						/>
					{/snippet}
				</Calendar.GridBody>
			</Calendar.Grid>
