	...
	{#each placements as placement (placement)}
		<Popover.Root>
			...
			<Popover.Content
				{placement}
				offset={8}
				class="border border-neutral-200 bg-white p-3 shadow-md dark:border-neutral-800 dark:bg-neutral-900"
			>
