...
<div class="w-full max-w-xs">
	<LocaleProvider locale="en-US">
		<TimePicker.Root bind:value hourCycle={12} class="group space-y-2">
			<div
			...
			<TimePicker.Popover
				placement="bottom"
				class="mt-1 rounded-lg border border-neutral-200 bg-white p-2 shadow-md dark:border-neutral-800 dark:bg-neutral-900"
			>
