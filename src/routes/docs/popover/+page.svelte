<script lang="ts">
	...
	import type { ExtendedPlacement } from '$lib/primitives/floating';
				...
				{#snippet children()}
					<Popover.Root bind:open={isOpen}>
						...
						<Popover.Content
							...
							{shouldCloseOnEscape}
							class="w-[280px] rounded-xl bg-white p-4 shadow-xl dark:bg-gray-800"
						>
				...
				{#snippet children()}
					<div class="flex flex-col items-center gap-4">
						...
						<Popover.Root bind:open={controlledOpen}>
							...
							<Popover.Content class="w-[280px] rounded-xl bg-white p-4 shadow-xl dark:bg-gray-800">
					...
					<div class="flex gap-8">
						<div class="text-center">
							...
							<Popover.Root>
								...
								<Popover.Content
									isNonModal={false}
									class="w-[250px] rounded-xl bg-white p-4 shadow-xl dark:bg-gray-800"
								>
			...
			>
				{#snippet children()}
					<Popover.Root>
						...
						<Popover.Content class="w-[300px] rounded-xl bg-white shadow-xl dark:bg-gray-800">
